...
<div class="container-fluid">
    ...
    @endif
    @if($counts > 0)<div class="alert alert-warning text-center">anda mempunyai permintaan pengiriman yang tertunda &nbsp;<a href="{{url('pending/'.Auth::user()->id)}}">Lihat Disini</a></div>@endif
        ...
        <div class="card-body row">
            ...
            @if (NULL != $current_items->first())
                ...
                <div class="card col-md-3 px-0 border-dark border-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title h-50">{{Str::limit($item->item_name, 27)}} </h4>
                    ...
                    <div class="card-footer row">
                        ...
                        <div class="btn-group p-1">
                            ...
                            <a href="{{url('/item/'.$item->id)}}" class="btn btn-warning">Live View</a>    
                        </div>
                        <br>
